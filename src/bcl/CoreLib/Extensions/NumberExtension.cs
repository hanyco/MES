...
public static class NumberExtension
{
    ...
    extension(int? @this)
    {
        ...
        /// </summary>
        public string ToString(string format = "0", int defaultValue = 0) =>
    ...
    extension(int)
    {
        ...
        /// </summary>
        public static string ToPersianDigits(int value) =>
    ...
    extension(long @this)
    {
        ...
        //Finally, it returns a string with the value and the corresponding size suffix.
        {
            ...
            if (@this < 0)
            {
                return "-" + (-@this).ToStandardMetricScale(measure, decimalPlaces);
            }
